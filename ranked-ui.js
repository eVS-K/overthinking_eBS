...
(function exposeRankedUi(root, factory) {
  ...
  const ERROR_MESSAGES = Object.freeze({
    ...
    INVALID_PROFILE_UPDATE: 'プロフィールの設定内容を確認してください。',
    ...
    RANKED_REQUEST_FAILED: 'ランク戦のデータを読み込めませんでした。サーバーの更新中または一時的な障害の可能性があります。時間をおいて再試行してください。',
    RANKED_PROFILE_UNAVAILABLE: 'サインインは完了していますが、ランク戦のプロフィールを読み込めませんでした。サーバーの更新中または一時的な障害の可能性があります。時間をおいて再試行してください。',
