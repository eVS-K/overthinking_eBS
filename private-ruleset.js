...
// A generated or copied card can keep an expanded match meaningful after the
// original deck has been exhausted.  Keep that extension explicit and bounded
// instead of silently treating the initial deck size as the round ceiling.
const MAX_PRIVATE_ROUND_EXTENSION_FROM_INITIAL_DECK = 10;
const MAX_PRIVATE_ROUNDS = MAX_PRIVATE_INITIAL_CARDS_PER_SIDE
